...
export function unpackCascade(bytes: Int8Array): void {
    ...
    */
    ...
    for (let t = 0; t < ntrees; ++t) {
        ...
        // console.log('byteSlice', byteSlice)
        // console.log('byteSlice.length', byteSlice.length)
        for (let i = 0, k = byteSlice.length; i < k; ++i) {
            // console.log('byteSlice[i]', byteSlice[i]);
